...
class AppColors {
  ...
  static const Color defaultBottomTab = secondaryText;

  static const Color primaryGray = Color(0xFFd7dee9);
  static const Color primaryYellow = Color(0xFFfceecb);
  ...
  static const Color primaryBlueLight = Color(0xFFf1f6fd);
