...
class AppTextStyle {
  ...
  static TextStyle secondaryBodyText =
      const TextStyle(color: AppColors.secondaryText, fontSize: bodyTextSize);
  static TextStyle darkSubtitle700 = const TextStyle(
      color: AppColors.darkText,
      fontSize: subTitleTextSize,
      fontWeight: FontWeight.w700);
  static TextStyle secondarySubtitle500 = const TextStyle(
  ...
  static TextStyle settingOptions = const TextStyle(
    fontSize: subTitleTextSize,
    fontWeight: FontWeight.w600,
  );
  static TextStyle headerTextBold =
      const TextStyle(fontSize: headerTextSize, fontWeight: FontWeight.bold);
  static TextStyle largeHeaderBold = const TextStyle(
  ...
  static TextStyle subtitleText =
      const TextStyle(fontSize: subTitleTextSize, fontWeight: FontWeight.w500);
  static TextStyle titleText =
      const TextStyle(fontSize: titleTextSize, fontWeight: FontWeight.w500);
  ...
  static TextStyle headerDark600 = const TextStyle(
      color: AppColors.darkText,
      fontSize: headerTextSize,
      fontWeight: FontWeight.w600);
  static TextStyle titleBlack600 = const TextStyle(
      color: AppColors.blackColor,
      fontSize: titleTextSize,
      fontWeight: FontWeight.w600);

  static TextStyle subtitleGreyBold = const TextStyle(
      fontSize: subTitleTextSize,
      fontWeight: FontWeight.bold,
  ...
  static const TextStyle mediumDark = TextStyle(
      ...
      fontWeight: FontWeight.w500);
  static const TextStyle bodyDarkGrey = TextStyle(
...
class AppFontStyle {
  static const buttonTextStyle =
      TextStyle(color: AppColors.primaryBlue, fontSize: subTitleTextSize);
  static const appbarHeaderStyle = TextStyle(
      color: AppColors.blackColor,
      fontSize: headerTextSize,
      fontWeight: FontWeight.bold);
