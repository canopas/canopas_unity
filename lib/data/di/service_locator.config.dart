...
extension GetItInjectableX on _i1.GetIt {
  ...
  Future<_i1.GetIt> init({
    ...
    gh.factory<_i42.AddMemberBloc>(
        () => _i42.AddMemberBloc(gh<_i28.EmployeeService>()));
    gh.factory<_i43.AdminEditEmployeeDetailsBloc>(
        () => _i43.AdminEditEmployeeDetailsBloc(gh<_i28.EmployeeService>()));
    gh.factory<_i44.AdminEmployeeDetailsLeavesBLoc>(
        () => _i44.AdminEmployeeDetailsLeavesBLoc(gh<_i31.LeaveService>()));
    gh.factory<_i45.AdminHomeBloc>(() => _i45.AdminHomeBloc(
          gh<_i31.LeaveService>(),
          gh<_i28.EmployeeService>(),
        ));
    gh.factory<_i46.AdminLeaveApplicationDetailsBloc>(
        () => _i46.AdminLeaveApplicationDetailsBloc(
              gh<_i31.LeaveService>(),
              gh<_i22.UserManager>(),
              gh<_i17.SpaceService>(),
            ));
    gh.factory<_i47.AdminLeaveDetailBloc>(() => _i47.AdminLeaveDetailBloc(
          gh<_i31.LeaveService>(),
          gh<_i22.UserManager>(),
          gh<_i17.SpaceService>(),
        ));
    gh.factory<_i48.AdminLeavesBloc>(() => _i48.AdminLeavesBloc(
          gh<_i31.LeaveService>(),
          gh<_i28.EmployeeService>(),
        ));
    gh.factory<_i49.ApplyLeaveBloc>(() => _i49.ApplyLeaveBloc(
          gh<_i22.UserManager>(),
          gh<_i31.LeaveService>(),
        ));
    gh.factory<_i50.ChangeSpaceBloc>(() => _i50.ChangeSpaceBloc(
          gh<_i22.UserManager>(),
          gh<_i17.SpaceService>(),
          gh<_i28.EmployeeService>(),
          gh<_i20.AccountService>(),
        ));
    gh.factory<_i51.CreateSpaceBLoc>(() => _i51.CreateSpaceBLoc(
          gh<_i17.SpaceService>(),
          gh<_i22.UserManager>(),
          gh<_i28.EmployeeService>(),
          gh<_i12.ImagePicker>(),
    ...
    gh.factory<_i52.DrawerBloc>(() => _i52.DrawerBloc(
          gh<_i17.SpaceService>(),
          gh<_i22.UserManager>(),
          gh<_i20.AccountService>(),
          gh<_i28.EmployeeService>(),
    ...
    gh.factory<_i54.EmployeeEditProfileBloc>(() => _i54.EmployeeEditProfileBloc(
          gh<_i28.EmployeeService>(),
    ...
    gh.factory<_i55.EmployeeListBloc>(
        () => _i55.EmployeeListBloc(gh<_i28.EmployeeService>()));
    gh.factory<_i56.EmployeesCalendarLeavesBloc>(
        () => _i56.EmployeesCalendarLeavesBloc(
              gh<_i28.EmployeeService>(),
              gh<_i31.LeaveService>(),
              gh<_i22.UserManager>(),
            ));
