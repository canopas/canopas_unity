...
import 'package:projectunity/data/Repo/employee_repo.dart' as _i42;
import 'package:projectunity/data/Repo/leave_repo.dart' as _i44;
...
extension GetItInjectableX on _i1.GetIt {
  ...
  Future<_i1.GetIt> init({
    ...
    gh.factory<_i32.UserEmployeeDetailBloc>(
        () => _i32.UserEmployeeDetailBloc(gh<_i30.LeaveService>()));
    ...
    gh.lazySingleton<_i42.EmployeeRepo>(
      () => _i42.EmployeeRepo(
        gh<_i27.EmployeeService>(),
        gh<_i22.UserStateNotifier>(),
      ),
    ...
    gh.lazySingleton<_i44.LeaveRepo>(
      () => _i44.LeaveRepo(gh<_i30.LeaveService>()),
      dispose: (i) => i.dispose(),
    );
    gh.factory<_i45.UserEmployeesBloc>(
        () => _i45.UserEmployeesBloc(gh<_i42.EmployeeRepo>()));
    gh.factory<_i46.UserHomeBloc>(() => _i46.UserHomeBloc(
          gh<_i22.UserStateNotifier>(),
          gh<_i44.LeaveRepo>(),
        ));
    gh.factory<_i47.UserLeaveBloc>(() => _i47.UserLeaveBloc(
          gh<_i22.UserStateNotifier>(),
          gh<_i44.LeaveRepo>(),
        ));
    gh.factory<_i48.UserStateControllerBloc>(() => _i48.UserStateControllerBloc(
          gh<_i42.EmployeeRepo>(),
          gh<_i22.UserStateNotifier>(),
          gh<_i19.SpaceService>(),
        ));
    ...
    gh.factory<_i51.AdminEmployeeDetailsLeavesBLoc>(
        () => _i51.AdminEmployeeDetailsLeavesBLoc(gh<_i44.LeaveRepo>()));
