...
extension GetItInjectableX on _i1.GetIt {
  ...
  Future<_i1.GetIt> init({
    ...
    gh.factory<_i40.AdminEmployeeDetailsLeavesBLoc>(
        () => _i40.AdminEmployeeDetailsLeavesBLoc(gh<_i30.LeaveService>()));
    ...
    gh.factory<_i45.EmployeeDetailBloc>(() => _i45.EmployeeDetailBloc(
          gh<_i23.AccountService>(),
          gh<_i19.SpaceService>(),
          gh<_i22.UserStateNotifier>(),
          gh<_i27.EmployeeService>(),
    ...
    gh.factory<_i48.EmployeesCalendarLeavesBloc>(
        () => _i48.EmployeesCalendarLeavesBloc(
              gh<_i27.EmployeeService>(),
              gh<_i30.LeaveService>(),
            ));
    gh.lazySingleton<_i49.LeaveRepo>(
      () => _i49.LeaveRepo(gh<_i30.LeaveService>()),
      dispose: (i) => i.dispose(),
    );
    gh.factory<_i50.UserEmployeesBloc>(
        () => _i50.UserEmployeesBloc(gh<_i47.EmployeeRepo>()));
