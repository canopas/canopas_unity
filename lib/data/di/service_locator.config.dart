...
import 'package:projectunity/data/repo/employee_repo.dart' as _i50;
...
extension GetItInjectableX on _i1.GetIt {
  ...
  Future<_i1.GetIt> init({
    ...
    gh.factory<_i43.AdminFormListBloc>(
        () => _i43.AdminFormListBloc(gh<_i31.FormRepo>()));
    gh.factory<_i44.AdminLeaveDetailsBloc>(() => _i44.AdminLeaveDetailsBloc(
          gh<_i34.LeaveRepo>(),
          gh<_i18.NotificationService>(),
        ));
    ...
    gh.factory<_i46.CreateFormBloc>(() => _i46.CreateFormBloc(
          gh<_i31.FormRepo>(),
          gh<_i14.ImagePicker>(),
          gh<_i23.StorageService>(),
          gh<_i25.UserStateNotifier>(),
        ));
    gh.factory<_i47.CreateSpaceBLoc>(() => _i47.CreateSpaceBLoc(
          gh<_i22.SpaceService>(),
          gh<_i25.UserStateNotifier>(),
          gh<_i30.EmployeeService>(),
          gh<_i14.ImagePicker>(),
    ...
    gh.lazySingleton<_i50.EmployeeRepo>(
      () => _i50.EmployeeRepo(
        gh<_i30.EmployeeService>(),
        gh<_i25.UserStateNotifier>(),
        gh<_i10.FirebaseCrashlytics>(),
    ...
    gh.factory<_i51.UserEmployeesBloc>(
        () => _i51.UserEmployeesBloc(gh<_i50.EmployeeRepo>()));
    gh.factory<_i52.UserStateControllerBloc>(() => _i52.UserStateControllerBloc(
          gh<_i50.EmployeeRepo>(),
          gh<_i25.UserStateNotifier>(),
          gh<_i22.SpaceService>(),
          gh<_i21.SpaceChangeNotifier>(),
        ));
    ...
    gh.factory<_i58.EmployeeDetailBloc>(() => _i58.EmployeeDetailBloc(
          gh<_i26.AccountService>(),
          gh<_i22.SpaceService>(),
          gh<_i25.UserStateNotifier>(),
          gh<_i30.EmployeeService>(),
