...
import 'package:projectunity/data/services/employee_service.dart' as _i19;
import 'package:projectunity/data/services/leave_service.dart' as _i21;
...
extension GetItInjectableX on _i1.GetIt {
  ...
  Future<_i1.GetIt> init({
    ...
    gh.factory<_i15.AdminSettingUpdatePaidLeaveCountBloc>(
        () => _i15.AdminSettingUpdatePaidLeaveCountBloc(
              gh<_i10.SpaceService>(),
              gh<_i13.UserManager>(),
            ));
    gh.factory<_i16.AdminSettingsBloc>(() => _i16.AdminSettingsBloc(
          gh<_i13.UserManager>(),
          gh<_i12.AuthService>(),
        ));
    gh.factory<_i17.AppRouter>(() => _i17.AppRouter(gh<_i13.UserManager>()));
    gh.factory<_i18.EditSpaceBloc>(() => _i18.EditSpaceBloc(
          gh<_i10.SpaceService>(),
          gh<_i13.UserManager>(),
        ));
    gh.lazySingleton<_i19.EmployeeService>(
        () => _i19.EmployeeService(gh<_i13.UserManager>()));
    gh.factory<_i20.JoinSpaceBloc>(() => _i20.JoinSpaceBloc(
          gh<_i10.SpaceService>(),
          gh<_i13.UserManager>(),
          gh<_i19.EmployeeService>(),
        ));
    gh.singleton<_i21.LeaveService>(_i21.LeaveService(gh<_i13.UserManager>()));
    ...
    gh.factory<_i29.UserLeaveDetailBloc>(
        () => _i29.UserLeaveDetailBloc(gh<_i21.LeaveService>()));
    gh.factory<_i30.WhoIsOutCardBloc>(() => _i30.WhoIsOutCardBloc(
          gh<_i19.EmployeeService>(),
          gh<_i21.LeaveService>(),
        ));
    gh.factory<_i31.AddMemberBloc>(
        () => _i31.AddMemberBloc(gh<_i19.EmployeeService>()));
    gh.factory<_i32.AdminEditEmployeeDetailsBloc>(
        () => _i32.AdminEditEmployeeDetailsBloc(gh<_i19.EmployeeService>()));
    gh.factory<_i33.AdminEmployeeDetailsLeavesBLoc>(
        () => _i33.AdminEmployeeDetailsLeavesBLoc(gh<_i21.LeaveService>()));
    ...
    gh.factory<_i40.EmployeeDetailBloc>(() => _i40.EmployeeDetailBloc(
          gh<_i10.SpaceService>(),
          gh<_i13.UserManager>(),
          gh<_i19.EmployeeService>(),
          gh<_i21.LeaveService>(),
        ));
    gh.factory<_i41.EmployeeEditProfileBloc>(() => _i41.EmployeeEditProfileBloc(
          gh<_i19.EmployeeService>(),
          gh<_i11.UserPreference>(),
          gh<_i13.UserManager>(),
        ));
    gh.factory<_i42.EmployeeListBloc>(
        () => _i42.EmployeeListBloc(gh<_i19.EmployeeService>()));
    gh.factory<_i43.EmployeesCalendarLeavesBloc>(
        () => _i43.EmployeesCalendarLeavesBloc(
              gh<_i19.EmployeeService>(),
              gh<_i21.LeaveService>(),
              gh<_i13.UserManager>(),
            ));
