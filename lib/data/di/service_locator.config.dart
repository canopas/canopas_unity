...
import 'package:projectunity/data/Repo/leave_repo.dart' as _i47;
...
extension GetItInjectableX on _i1.GetIt {
  ...
  Future<_i1.GetIt> init({
    ...
    gh.factory<_i40.ApplyLeaveBloc>(() => _i40.ApplyLeaveBloc(
          gh<_i22.UserStateNotifier>(),
          gh<_i30.LeaveService>(),
          gh<_i16.NotificationService>(),
        ));
    ...
    gh.factory<_i42.DrawerBloc>(() => _i42.DrawerBloc(
          gh<_i19.SpaceService>(),
          gh<_i22.UserStateNotifier>(),
          gh<_i23.AccountService>(),
          gh<_i27.EmployeeService>(),
        ));
    gh.factory<_i43.EmployeeDetailBloc>(() => _i43.EmployeeDetailBloc(
          gh<_i23.AccountService>(),
          gh<_i19.SpaceService>(),
          gh<_i22.UserStateNotifier>(),
          gh<_i27.EmployeeService>(),
    ...
    gh.factory<_i46.EmployeesCalendarLeavesBloc>(
        () => _i46.EmployeesCalendarLeavesBloc(
              gh<_i27.EmployeeService>(),
              gh<_i30.LeaveService>(),
            ));
    gh.lazySingleton<_i47.LeaveRepo>(
      () => _i47.LeaveRepo(gh<_i30.LeaveService>()),
      dispose: (i) => i.dispose(),
    );
    gh.factory<_i48.UserEmployeesBloc>(
        () => _i48.UserEmployeesBloc(gh<_i45.EmployeeRepo>()));
    gh.factory<_i49.UserHomeBloc>(() => _i49.UserHomeBloc(
          gh<_i22.UserStateNotifier>(),
          gh<_i47.LeaveRepo>(),
        ));
    gh.factory<_i50.UserLeaveBloc>(() => _i50.UserLeaveBloc(
          gh<_i22.UserStateNotifier>(),
          gh<_i47.LeaveRepo>(),
        ));
