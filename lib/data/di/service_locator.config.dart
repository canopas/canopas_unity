...
import 'package:projectunity/data/Repo/leave_repo.dart' as _i48;
...
extension GetItInjectableX on _i1.GetIt {
  ...
  Future<_i1.GetIt> init({
    ...
    gh.factory<_i39.AdminEmployeeDetailsLeavesBLoc>(
        () => _i39.AdminEmployeeDetailsLeavesBLoc(gh<_i30.LeaveService>()));
    ...
    gh.lazySingleton<_i48.LeaveRepo>(
      () => _i48.LeaveRepo(gh<_i30.LeaveService>()),
      dispose: (i) => i.dispose(),
    );
    gh.factory<_i49.UserEmployeesBloc>(
        () => _i49.UserEmployeesBloc(gh<_i46.EmployeeRepo>()));
    gh.factory<_i50.UserHomeBloc>(() => _i50.UserHomeBloc(
          gh<_i22.UserStateNotifier>(),
          gh<_i48.LeaveRepo>(),
        ));
    gh.factory<_i51.UserLeaveBloc>(() => _i51.UserLeaveBloc(
          gh<_i22.UserStateNotifier>(),
          gh<_i48.LeaveRepo>(),
        ));
