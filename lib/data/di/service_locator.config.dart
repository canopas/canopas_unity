...
import 'package:uuid/uuid.dart' as _i18; // ignore_for_file: unnecessary_lambdas
...
extension GetItInjectableX on _i1.GetIt {
  ...
  Future<_i1.GetIt> init({
    ...
    gh.factory<_i18.Uuid>(() => appModule.uuid);
    ...
    gh.factory<_i29.EmployeeListBloc>(
        () => _i29.EmployeeListBloc(gh<_i7.EmployeeService>()));
    ...
    gh.factory<_i39.SignInScreenBloc>(() => _i39.SignInScreenBloc(
          gh<_i36.AuthManager>(),
          gh<_i30.UserManager>(),
          gh<_i27.AuthService>(),
        ));
