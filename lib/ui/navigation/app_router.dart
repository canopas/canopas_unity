...
import '../admin/members/list/employee_list_screen.dart';
...
import '../user/members/list/user_employees_screen.dart';
          ...
          ShellRoute(
              ...
              routes: [
                ...
                GoRoute(
                    ...
                    pageBuilder: (context, state) {
                      return const CupertinoPage(child: AdminLeavesPage());
                    },
                    routes: <GoRoute>[
                      GoRoute(
                        parentNavigatorKey: _adminShellNavigatorKey,
          ...
          ShellRoute(
              ...
              routes: <GoRoute>[
                ...
                GoRoute(
                    ...
                    pageBuilder: (context, state) =>
                        const CupertinoPage(child: UserEmployeesPage()),
                    routes: <GoRoute>[
                      GoRoute(
                        parentNavigatorKey: _employeeShellNavigatorKey,
