...
class UserLeaveDetailScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        body: ListView(
          children: [
            LeaveTypeAgoTitle(timeAgo: leave.appliedOn.toDate.timeAgo(),leaveType: leave.leaveType),
            const SizedBox(height: primaryHorizontalSpacing,),
            RemainingLeaveContainer(leave: leave,employeeId: _userManager.employeeId),
            ReasonField(reason: leave.reason,),
            ApprovalStatusTag(leaveStatus: leave.leaveStatus,rejectionReason: leave.rejectionReason),
          ],
        ),
