          ...
          if (state is UpcomingLeaveViewLoadingState) {
            ...
            if (state.leaveApplications.isEmpty) {
              return EmptyScreen(
                ...
                onActionButtonTap: () => context.read<UpcomingLeavesViewBloc>().add(NavigateToLeaveRequestViewUpcomingLeavesEvent()),
              ...
              return ListView.separated(
                ...
                itemBuilder: (BuildContext context, int index) => LeaveCard(
                    onTap: () => context.read<UpcomingLeavesViewBloc>().add(
                        NavigateToLeaveDetailsViewUpcomingLeavesEvent(leaveApplication: state.leaveApplications[index])),
