...
class UserLeaveCalendarPage extends StatelessWidget {
  final String userId;
  const UserLeaveCalendarPage({Key? key, required this.userId}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return MultiBlocProvider(
      ...
      BlocProvider(
        create: (_) => getIt<UserLeaveCalendarBloc>()..add(UserLeaveCalendarInitialLoadEvent(userId)),
      ),
    ],
...
class UserLeaveCalendarScreen extends StatefulWidget {
  ...
  @override
  State<UserLeaveCalendarScreen> createState() => _UserLeaveCalendarScreenState();
}
    ...
    return Scaffold(
      ...
      body: Column(
        children: [
          CalendarCard(
            calendar: TableCalendar(
              ...
              onRangeSelected: (startDate, endDate, selectedDate) {
                context.read<UserLeaveCalendarBloc>().add(DateRangeSelectedEvent(startDate, endDate, selectedDate));
              ...
              eventLoader: (day){
                UserLeaveCalendarViewState state =  context.watch<UserLeaveCalendarBloc>().state;
          ...
          Expanded(
            child: BlocBuilder<UserLeaveCalendarBloc,UserLeaveCalendarViewState>(
