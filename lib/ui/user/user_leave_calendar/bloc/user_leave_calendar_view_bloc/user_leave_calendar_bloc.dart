...
@Injectable()
class UserLeaveCalendarBloc extends Bloc<UserLeaveCalendarEvent,UserLeaveCalendarViewState>{
  ...
  UserLeaveCalendarBloc( this._userLeaveService, this._employeeService, this._paidLeaveService) :
