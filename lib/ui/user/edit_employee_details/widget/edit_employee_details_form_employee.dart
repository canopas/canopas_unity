...
import 'package:projectunity/ui/user/edit_employee_details/widget/profile_pic_with_edit_button.dart';
                ...
                Expanded(
                  ...
                  onPressed: () {
                    bloc.add(ChangeGenderEvent(
                        gender:
                            state.gender == EmployeeGender.male ? null : EmployeeGender.male));
                  },
                  child: Text(
