...
class LeaveCalendarBloc extends Bloc<LeaveCalendarEvent, LeaveCalendarState> {
  ...
  void _onDateRangeSelected(
      DateRangeSelectedCalendarEvent event, Emitter<LeaveCalendarState> emit) {
    emit(state.copyWith(
  ...
  void _onCalendarFormatChange(
      ChangeCalendarFormatEvent event, Emitter<LeaveCalendarState> emit) {
    emit(state.changeCalendarFormatOnly(calendarFormat: event.calendarFormat));
  }

  void _onCalendarFormatChangeBySwipe(ChangeCalendarFormatBySwipeEvent event,
      Emitter<LeaveCalendarState> emit) {
    CalendarFormat calendarFormat =
        state.calendarFormat.changeCalendarFormatBySwipe(event.direction);
