        ...
        child: ScrollOnExpand(
          ...
          child: ExpandablePanel(
              ...
              header:  Padding(
                  ...
                  child: Text(
                    title,
                    style: const TextStyle(fontWeight: FontWeight.bold,color: AppColors.greyColor,fontSize: 18),
                  )),
              collapsed: leaves.isNotEmpty?LeaveCard(totalDays:leaves[0].totalLeaves,
                  type: leaves[0].leaveType,
                  startDate: leaves[0].startDate,
                  endDate: leaves[0].endDate,
                  status: leaves[0].leaveStatus):const Text('No any leaves yet!'),

              expanded:leaves.isNotEmpty? ListView.builder(
                  shrinkWrap: true,
                ...
                return Column(
                  children: [
                    ...
                    Builder(builder: (context){
                      ...
                      return TextButton(onPressed: (){controller.toggle();}, child: Text(controller.expanded?"View more":"show less"));})
                  ],
                );
              }
          ),
