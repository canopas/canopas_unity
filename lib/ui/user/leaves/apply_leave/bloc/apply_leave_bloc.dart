...
class ApplyLeaveBloc extends Bloc<ApplyLeaveEvent, ApplyLeaveState>
  ...
  void _updateStartLeaveDate(
    ApplyLeaveStartDateChangeEvents event,
  ...
  void _updateLeaveType(
    ApplyLeaveChangeLeaveTypeEvent event,
    Emitter<ApplyLeaveState> emit,
  ) {
  ...
  void _updateEndLeaveDate(
    ApplyLeaveEndDateChangeEvent event,
    Emitter<ApplyLeaveState> emit,
  ) {
    final Map<DateTime, LeaveDayDuration> updatedSelectedLeaves = {};
    updatedSelectedLeaves.addAll(state.selectedDates);
  ...
  void _updateReason(
    ApplyLeaveReasonChangeEvent event,
    Emitter<ApplyLeaveState> emit,
  ) {
  ...
  Future<void> _applyLeave(
    ApplyLeaveSubmitFormEvent event,
    Emitter<ApplyLeaveState> emit,
  ) async {
  ...
  Leave _getLeaveData() {
    final entries = state.selectedDates.entries.where(
