...
import 'package:projectunity/ui/admin/absence/detail/widget/user_content.dart';
...
import '../../../../bloc/admin/leave/admin_leave_details_bloc.dart';
        ...
        children: [
          ...
          RemainingLeaveContainer(
              remainingLeaveStream:
                  _adminDetailsScreenBloc.remainingLeaveStream,
