...
@Injectable()
class AdminLeaveDetailsBloc extends Bloc<
    AdminLeaveDetailsEvents, AdminLeaveDetailsState> {
  ...
  Future<void> _responseToLeaveApplication(LeaveResponseEvent event,
      Emitter<AdminLeaveDetailsState> emit) async {
  ...
  void _onReplyChange(ReasonChangedEvent event,
