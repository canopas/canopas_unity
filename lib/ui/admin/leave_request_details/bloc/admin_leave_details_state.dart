...
class AdminLeaveApplicationDetailsState extends Equatable{
  ...
  AdminLeaveDetailsState copyWith({int? paidLeaveCount,double? remainingLeaveCount, String? error, AdminLeaveApplicationDetailsStatus? leaveDetailsStatus, AdminLeaveApplicationDetailsLeaveCountStatus? leaveDetailsLeaveCountStatus, String? adminReply}){
