  ...
  Widget build(BuildContext context) {
    return Scaffold(
        body: Padding(
          ...
          child: Column(
            children: [
              Text('Hi  ${_userManager.getUserName() ?? ''} !',style:const TextStyle(
                  fontSize: 30,
                  color: Colors.black,
             ...
             const Text(
              ...
              OutlinedButton(
                  onPressed: (){},
                  child:const Text('All Leaves',style: TextStyle(
              ...
              OutlinedButton(
                  onPressed: (){},
                  child:const Text('Upcoming leaves',style: TextStyle(
                      color: Colors.blueGrey,
                      fontSize: 20
                  )),
                  style: ElevatedButton.styleFrom(
              ...
              OutlinedButton(
                  onPressed: (){},
                  child:const Text('Team Leaves',style: TextStyle(
                      color: Colors.blueGrey,
                      fontSize: 20
                  )),
                  style: ElevatedButton.styleFrom(
