...
import '../Navigation%20/app_state_manager.dart' as _i3;
import '../Navigation%20/login_state.dart' as _i16;
...
import '../services/login/login_request_provider.dart' as _i5;
import '../services/login/login_service.dart' as _i6;
...
Future<_i1.GetIt> $initGetIt(_i1.GetIt get,
  ...
  gh.factory<_i5.LoginRequestDataProvider>(
      () => _i5.LoginRequestDataProvider());
  gh.factory<_i6.LoginService>(
      () => _i6.LoginService(get<_i5.LoginRequestDataProvider>()));
  ...
  gh.singleton<_i9.ApplyForLeaveApiService>(
      _i9.ApplyForLeaveApiService(get<_i4.Dio>(), get<_i8.UserPreference>()));
  gh.factory<_i10.EmployeeDetailApiService>(() =>
      _i10.EmployeeDetailApiService(get<_i4.Dio>(), get<_i8.UserPreference>()));
  gh.factory<_i11.EmployeeListApiService>(() =>
      _i11.EmployeeListApiService(get<_i4.Dio>(), get<_i8.UserPreference>()));
  gh.factory<_i12.LoginApiService>(() => _i12.LoginApiService(
      get<_i8.UserPreference>(), get<_i4.Dio>(), get<_i6.LoginService>()));
  gh.singleton<_i13.TeamLeavesApiService>(
      _i13.TeamLeavesApiService(get<_i4.Dio>(), get<_i8.UserPreference>()));
  gh.singleton<_i14.UserLeavesApiService>(
      _i14.UserLeavesApiService(get<_i4.Dio>(), get<_i8.UserPreference>()));
