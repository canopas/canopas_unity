...
import '../bloc/admin/employee/add_memeber_bloc.dart' as _i23;
...
import '../bloc/admin/setting/total_paid_leave_count_bloc.dart' as _i24;
import '../bloc/authentication/login_bloc.dart' as _i27;
import '../bloc/authentication/logout_bloc.dart' as _i26;
import '../bloc/employee/home/employee_home_bloc.dart' as _i19;
import '../bloc/employee/leave/apply_leave_bloc.dart' as _i25;
import '../bloc/employee/leave/user_leave_bloc.dart' as _i22;
...
import '../provider/user_data.dart' as _i18;
...
import '../ui/onboard/onboard_bloc.dart' as _i21;
...
Future<_i1.GetIt> $initGetIt(
  ...
  gh.singleton<_i18.UserManager>(_i18.UserManager(get<_i11.UserPreference>()));
  gh.factory<_i19.EmployeeHomeBLoc>(() => _i19.EmployeeHomeBLoc(
        get<_i18.UserManager>(),
        get<_i10.UserLeaveService>(),
        get<_i8.PaidLeaveService>(),
      ));
  gh.singleton<_i20.NavigationStackManager>(
    _i20.NavigationStackManager(get<_i18.UserManager>()),
    dispose: (i) => i.dispose(),
  );
  gh.factory<_i21.OnBoardBloc>(() => _i21.OnBoardBloc(
        get<_i11.UserPreference>(),
        get<_i20.NavigationStackManager>(),
      ));
  gh.singleton<_i22.UserLeavesBloc>(_i22.UserLeavesBloc(
    get<_i10.UserLeaveService>(),
    get<_i18.UserManager>(),
  ));
  ...
  gh.factory<_i24.AdminPaidLeaveCountBloc>(() => _i24.AdminPaidLeaveCountBloc(
        get<_i8.PaidLeaveService>(),
        get<_i20.NavigationStackManager>(),
      ));
  gh.factory<_i25.ApplyLeaveBloc>(() => _i25.ApplyLeaveBloc(
        get<_i18.UserManager>(),
        get<_i10.UserLeaveService>(),
        get<_i20.NavigationStackManager>(),
      ));
