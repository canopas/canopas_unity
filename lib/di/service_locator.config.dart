...
import '../router/app_router.dart' as _i30;
...
import '../stateManager/auth/auth_manager.dart' as _i32;
...
import '../ui/admin/edit_employe_details/bloc/admin_edit_employee_details_bloc.dart'
    as _i19;
import '../ui/admin/employee/detail/bloc/employee_detail_bloc.dart' as _i33;
...
import '../ui/admin/leave_request_details/bloc/admin_leave_details_bloc.dart'
    as _i21;
import '../ui/admin/setting/bloc/admin_settings_bloc.dart' as _i28;
...
import '../ui/user/user_home/bloc/user_home_bloc.dart' as _i40;
...
import '../ui/user/user_leave_calendar/bloc/user_leave_calendar_view_bloc/user_leave_calendar_bloc.dart'
    as _i25;
import '../ui/user/user_settings/bloc/user_settings_bloc.dart' as _i27;
...
Future<_i1.GetIt> $initGetIt(
  ...
  gh.singleton<_i26.UserManager>(_i26.UserManager(get<_i16.UserPreference>()));
  gh.factory<_i27.UserSettingsBloc>(() => _i27.UserSettingsBloc(
        get<_i26.UserManager>(),
        get<_i23.AuthService>(),
        get<_i16.UserPreference>(),
      ));
  gh.factory<_i28.AdminSettingsBloc>(() => _i28.AdminSettingsBloc(
        get<_i26.UserManager>(),
        get<_i23.AuthService>(),
        get<_i16.UserPreference>(),
      ));
  gh.factory<_i29.AllLeavesBloc>(() => _i29.AllLeavesBloc(
        get<_i26.UserManager>(),
        get<_i15.UserLeaveService>(),
        get<_i13.PaidLeaveService>(),
      ));
  gh.factory<_i30.AppRouter>(() => _i30.AppRouter(get<_i26.UserManager>()));
  gh.factory<_i31.ApplyLeaveBloc>(() => _i31.ApplyLeaveBloc(
        get<_i26.UserManager>(),
        get<_i13.PaidLeaveService>(),
        get<_i15.UserLeaveService>(),
      ));
  gh.singleton<_i32.AuthManager>(_i32.AuthManager(
    get<_i16.UserPreference>(),
    get<_i23.AuthService>(),
  ));
  gh.factory<_i33.EmployeeDetailBloc>(() => _i33.EmployeeDetailBloc(
        get<_i8.EmployeeService>(),
        get<_i15.UserLeaveService>(),
        get<_i26.UserManager>(),
      ));
  gh.factory<_i34.EmployeeEditEmployeeDetailsBloc>(
      () => _i34.EmployeeEditEmployeeDetailsBloc(
            get<_i8.EmployeeService>(),
            get<_i16.UserPreference>(),
            get<_i26.UserManager>(),
          ));
