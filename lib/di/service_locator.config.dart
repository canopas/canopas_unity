...
import '../bloc/employee_detail_bloc.dart' as _i11;
import '../bloc/employee_list_bloc.dart' as _i12;
import '../bloc/employee_validation.dart' as _i5;
import '../bloc/login_bloc.dart' as _i13;
import '../bloc/team_leaves_bloc.dart' as _i21;
import '../bloc/user_leaves_bloc.dart' as _i22;
...
import '../services/employee/employee_service.dart' as _i4;
...
import '../services/network_repository.dart' as _i20;
...
Future<_i1.GetIt> $initGetIt(_i1.GetIt get,
  ...
  gh.singleton<_i5.EmployeeValidationBloc>(_i5.EmployeeValidationBloc());
  ...
  gh.singleton<_i19.NavigationStackManager>(
      _i19.NavigationStackManager(get<_i16.UserManager>()));
  gh.factory<_i20.NetworkRepository>(() => _i20.NetworkRepository(
      get<_i15.UserLeavesApiService>(), get<_i14.TeamLeavesApiService>()));
  gh.singleton<_i21.TeamLeavesBloc>(
      _i21.TeamLeavesBloc(get<_i20.NetworkRepository>()));
  gh.singleton<_i22.UserLeavesBloc>(
      _i22.UserLeavesBloc(get<_i20.NetworkRepository>()));
  return get;
}
