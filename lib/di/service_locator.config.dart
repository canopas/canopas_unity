...
import '../bloc/authentication/logout_bloc.dart' as _i33;
...
import '../stateManager/auth/auth_manager.dart' as _i29;
...
import '../ui/admin/setting/update_leave_count/bloc/admin_setting_update_paid_leave_button_state_bloc.dart'
    as _i4;
import '../ui/login/bloc/login_view_bloc.dart' as _i34;
...
import '../ui/user/leave/applyLeave/bloc/leave_request_form_bloc/apply_leave_bloc.dart'
    as _i28;
import '../ui/user/requested_leaves/bloc/requested_leaves_bloc.dart' as _i35;
import '../ui/user/upcoming_leaves/bloc/upcoming_leaves_bloc.dart' as _i36;
...
Future<_i1.GetIt> $initGetIt(
  ...
  gh.factory<_i26.AllLeavesBloc>(() => _i26.AllLeavesBloc(
        get<_i25.UserManager>(),
        get<_i15.UserLeaveService>(),
        get<_i13.PaidLeaveService>(),
      ));
  gh.factory<_i27.AppRouter>(() => _i27.AppRouter(get<_i25.UserManager>()));
  gh.factory<_i28.ApplyLeaveBloc>(() => _i28.ApplyLeaveBloc(
        get<_i25.UserManager>(),
        get<_i13.PaidLeaveService>(),
        get<_i15.UserLeaveService>(),
      ));
  gh.singleton<_i29.AuthManager>(_i29.AuthManager(
    get<_i16.UserPreference>(),
  ...
  gh.factory<_i32.LeaveDetailsBloc>(() => _i32.LeaveDetailsBloc(
        get<_i15.UserLeaveService>(),
        get<_i13.PaidLeaveService>(),
        get<_i25.UserManager>(),
      ));
  gh.factory<_i33.LogOutBloc>(() => _i33.LogOutBloc(
        get<_i16.UserPreference>(),
        get<_i22.AuthService>(),
        get<_i25.UserManager>(),
      ));
  gh.factory<_i34.LoginBloc>(() => _i34.LoginBloc(
        get<_i29.AuthManager>(),
        get<_i25.UserManager>(),
        get<_i22.AuthService>(),
      ));
  gh.factory<_i35.RequestedLeavesViewBloc>(() => _i35.RequestedLeavesViewBloc(
        get<_i13.PaidLeaveService>(),
        get<_i15.UserLeaveService>(),
        get<_i25.UserManager>(),
      ));
  gh.factory<_i36.UpcomingLeavesViewBloc>(() => _i36.UpcomingLeavesViewBloc(
        get<_i13.PaidLeaveService>(),
        get<_i15.UserLeaveService>(),
        get<_i25.UserManager>(),
      ));
