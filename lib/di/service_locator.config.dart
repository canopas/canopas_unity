...
extension GetItInjectableX on _i1.GetIt {
  ...
  Future<_i1.GetIt> init({
    ...
    gh.factory<_i11.NetworkConnectionBloc>(
        () => _i11.NetworkConnectionBloc(gh<_i5.Connectivity>()));
    ...
    gh.singleton<_i15.UserPreference>(
        _i15.UserPreference(gh<_i13.SharedPreferences>()));
    ...
    gh.factory<_i23.AdminSettingUpdatePaidLeaveCountBloc>(() =>
        _i23.AdminSettingUpdatePaidLeaveCountBloc(gh<_i12.PaidLeaveService>()));
    ...
    gh.factory<_i28.UserLeaveDetailBloc>(
        () => _i28.UserLeaveDetailBloc(gh<_i14.UserLeaveService>()));
    gh.singleton<_i29.UserManager>(_i29.UserManager(gh<_i15.UserPreference>()));
