...
import '../provider/user_data.dart' as _i31;
import '../router/app_router.dart' as _i34;
...
import '../stateManager/auth/auth_manager.dart' as _i36;
...
import '../ui/admin/edit_employe_details/bloc/admin_edit_employee_details_bloc.dart'
    as _i19;
import '../ui/admin/employee/detail/bloc/employee_detail_bloc.dart' as _i37;
...
import '../ui/admin/leaves/leave_screen/bloc%20/admin_leaves_bloc.dart' as _i24;
import '../ui/admin/setting/bloc/admin_settings_bloc.dart' as _i33;
...
import '../ui/user/home/home_screen/bloc/user_home_bloc.dart' as _i41;
...
import '../ui/user/home/leave_calendar/bloc/user_leave_calendar_view_bloc/user_leave_calendar_bloc.dart'
    as _i29;
import '../ui/user/leaves/apply_leave/bloc/apply_leave_bloc.dart' as _i35;
import '../ui/user/leaves/detail/bloc/user_leave_detail_bloc.dart' as _i30;
...
Future<_i1.GetIt> $initGetIt(
  ...
  gh.factory<_i25.AdminSettingUpdatePaidLeaveCountBloc>(() =>
      _i25.AdminSettingUpdatePaidLeaveCountBloc(get<_i12.PaidLeaveService>()));
  ...
  gh.factory<_i27.EmployeeListBloc>(
      () => _i27.EmployeeListBloc(get<_i7.EmployeeService>()));
  gh.factory<_i28.UserEmployeeDetailBloc>(() => _i28.UserEmployeeDetailBloc(
        get<_i7.EmployeeService>(),
        get<_i15.UserLeaveService>(),
      ));
  gh.factory<_i29.UserLeaveCalendarBloc>(() => _i29.UserLeaveCalendarBloc(
        get<_i15.UserLeaveService>(),
        get<_i7.EmployeeService>(),
        get<_i12.PaidLeaveService>(),
      ));
  gh.factory<_i30.UserLeaveDetailBloc>(
      () => _i30.UserLeaveDetailBloc(get<_i15.UserLeaveService>()));
  gh.singleton<_i31.UserManager>(_i31.UserManager(get<_i16.UserPreference>()));
  gh.factory<_i32.UserSettingsBloc>(() => _i32.UserSettingsBloc(
        get<_i31.UserManager>(),
  ...
  gh.factory<_i34.AppRouter>(() => _i34.AppRouter(get<_i31.UserManager>()));
  ...
  gh.factory<_i37.EmployeeDetailBloc>(() => _i37.EmployeeDetailBloc(
        get<_i12.PaidLeaveService>(),
        get<_i7.EmployeeService>(),
        get<_i15.UserLeaveService>(),
        get<_i31.UserManager>(),
      ));
  gh.factory<_i38.EmployeeEditEmployeeDetailsBloc>(
      () => _i38.EmployeeEditEmployeeDetailsBloc(
            get<_i7.EmployeeService>(),
            get<_i16.UserPreference>(),
            get<_i31.UserManager>(),
          ));
