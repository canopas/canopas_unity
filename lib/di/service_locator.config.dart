...
import 'package:projectunity/services/auth/auth_service.dart' as _i23;
...
import 'package:projectunity/ui/admin/setting/update_leave_count/bloc/admin_setting_update_paid_leave_button_state_bloc.dart'
    as _i4;
import 'package:projectunity/ui/login/bloc/login_view_bloc.dart' as _i38;
...
extension GetItInjectableX on _i1.GetIt {
  ...
  Future<_i1.GetIt> init({
    ...
    gh.factory<_i22.AdminSettingUpdatePaidLeaveCountBloc>(() =>
        _i22.AdminSettingUpdatePaidLeaveCountBloc(gh<_i11.PaidLeaveService>()));
    ...
    gh.factory<_i24.EmployeeListBloc>(
        () => _i24.EmployeeListBloc(gh<_i7.EmployeeService>()));
    ...
    gh.factory<_i27.UserLeaveDetailBloc>(
        () => _i27.UserLeaveDetailBloc(gh<_i13.UserLeaveService>()));
    gh.singleton<_i28.UserManager>(_i28.UserManager(gh<_i14.UserPreference>()));
    ...
    gh.factory<_i31.AppRouter>(() => _i31.AppRouter(gh<_i28.UserManager>()));
