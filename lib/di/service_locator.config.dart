...
import '../bloc/employee/employee_leave_count/employee_leave_count_bloc.dart'
    as _i21;
import '../bloc/admin/leave_details_screen/admin_leave_details_bloc.dart' as _i26;
import '../bloc/login/login_bloc.dart' as _i19;
import '../bloc/user/setting_view_bloc.dart' as _i24;
...
Future<_i1.GetIt> $initGetIt(_i1.GetIt get,
  ...
  gh.singleton<_i15.AbsenceBloc>(_i15.AbsenceBloc(
      get<_i6.EmployeeService>(), get<_i4.AdminLeaveService>()));
  gh.singleton<_i16.AuthManager>(
      _i16.AuthManager(get<_i14.UserPreference>(), get<_i5.AuthService>()));
  gh.singleton<_i17.EmployeeDetailBloc>(
      _i17.EmployeeDetailBloc(get<_i6.EmployeeService>()));
  gh.singleton<_i18.EmployeeListBloc>(
      _i18.EmployeeListBloc(get<_i6.EmployeeService>()));
  gh.singleton<_i19.LoginBloc>(_i19.LoginBloc(get<_i16.AuthManager>()));
  gh.singleton<_i20.UserManager>(_i20.UserManager(get<_i14.UserPreference>()));
  gh.singleton<_i21.EmployeeLeaveCountBlock>(_i21.EmployeeLeaveCountBlock(
      get<_i20.UserManager>(), get<_i13.UserLeaveService>()));
  gh.singleton<_i22.LoginState>(_i22.LoginState(get<_i20.UserManager>()));
  gh.singleton<_i23.NavigationStackManager>(
      _i23.NavigationStackManager(get<_i20.UserManager>()));
  gh.singleton<_i24.SettingViewBLoc>(
      _i24.SettingViewBLoc(get<_i14.UserPreference>(), get<_i22.LoginState>()));
  gh.singleton<_i25.UserLeavesBloc>(_i25.UserLeavesBloc(
      get<_i13.UserLeaveService>(), get<_i20.UserManager>()));
  gh.singleton<_i26.AdminLeaveDetailsScreenBloc>(_i26.AdminLeaveDetailsScreenBloc(get<_i13.UserLeaveService>()));
  return get;
}
