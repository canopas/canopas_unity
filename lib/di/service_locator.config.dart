...
import '../bloc/authentication/logout_bloc.dart' as _i39;
...
import '../services/auth/auth_service.dart' as _i26;
...
import '../ui/admin/admin_employees/bloc/admin_employees_bloc.dart' as _i21;
...
import '../ui/admin/leave_request_details/bloc/admin_leave_details_bloc.dart'
    as _i23;
import '../ui/admin/leaves/bloc%20/admin_leaves_bloc.dart' as _i24;
...
import '../ui/admin/setting/update_leave_count/bloc/admin_setting_update_paid_leave_button_state_bloc.dart'
    as _i4;
import '../ui/login/bloc/login_view_bloc.dart' as _i40;
...
import '../ui/user/all_leaves/bloc/filter_bloc/all_leaves_filter_bloc.dart'
    as _i5;
import '../ui/user/all_leaves/bloc/leaves_bloc/all_leaves_bloc.dart' as _i32;
import '../ui/user/applyLeave/bloc/leave_request_form_bloc/apply_leave_bloc.dart'
    as _i34;
import '../ui/user/edit_employee_details/bloc/edit_employee_details_employee_bloc.dart'
    as _i37;
import '../ui/user/leaves/bloc/leave_count/user_leave_count_bloc.dart' as _i45;
import '../ui/user/leaves/bloc/leaves/user_leave_bloc.dart' as _i44;
import '../ui/user/requested_leaves/bloc/requested_leaves_bloc.dart' as _i41;
import '../ui/user/upcoming_leaves/bloc/upcoming_leaves_bloc.dart' as _i42;
import '../ui/user/user_employees/bloc/user_employees_bloc.dart' as _i15;
import '../ui/user/user_home/bloc/user_home_bloc.dart' as _i43;
...
import '../ui/user/user_leave_calendar/bloc/user_leave_calendar_view_bloc/user_leave_calendar_bloc.dart'
    as _i28;
import '../ui/user/user_settings/bloc/user_settings_bloc.dart' as _i30;
...
Future<_i1.GetIt> $initGetIt(
  ...
  gh.factory<_i21.AdminEmployeesBloc>(
      () => _i21.AdminEmployeesBloc(get<_i8.EmployeeService>()));
  ...
  gh.factory<_i24.AdminLeavesBloc>(() => _i24.AdminLeavesBloc(
        get<_i3.AdminLeaveService>(),
        get<_i8.EmployeeService>(),
      ));
  gh.factory<_i25.AdminSettingUpdatePaidLeaveCountBloc>(() =>
      _i25.AdminSettingUpdatePaidLeaveCountBloc(get<_i13.PaidLeaveService>()));
  ...
  gh.factory<_i27.EmployeeListBloc>(
      () => _i27.EmployeeListBloc(get<_i8.EmployeeService>()));
  gh.factory<_i28.UserLeaveCalendarBloc>(() => _i28.UserLeaveCalendarBloc(
        get<_i16.UserLeaveService>(),
        get<_i8.EmployeeService>(),
        get<_i13.PaidLeaveService>(),
      ));
  gh.singleton<_i29.UserManager>(_i29.UserManager(get<_i17.UserPreference>()));
  ...
  gh.factory<_i32.AllLeavesBloc>(() => _i32.AllLeavesBloc(
        get<_i29.UserManager>(),
        get<_i16.UserLeaveService>(),
        get<_i13.PaidLeaveService>(),
      ));
  gh.factory<_i33.AppRouter>(() => _i33.AppRouter(get<_i29.UserManager>()));
  ...
  gh.factory<_i38.LeaveDetailsBloc>(() => _i38.LeaveDetailsBloc(
        get<_i16.UserLeaveService>(),
        get<_i13.PaidLeaveService>(),
        get<_i29.UserManager>(),
      ));
  ...
  gh.factory<_i41.RequestedLeavesViewBloc>(() => _i41.RequestedLeavesViewBloc(
        get<_i13.PaidLeaveService>(),
        get<_i16.UserLeaveService>(),
        get<_i29.UserManager>(),
      ));
  gh.factory<_i42.UpcomingLeavesViewBloc>(() => _i42.UpcomingLeavesViewBloc(
        get<_i13.PaidLeaveService>(),
        get<_i16.UserLeaveService>(),
        get<_i29.UserManager>(),
      ));
