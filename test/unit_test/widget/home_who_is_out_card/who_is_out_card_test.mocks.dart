...
// in projectunity/test/unit_test/widget/home_who_is_out_card/who_is_out_card_test.dart.
...
import 'package:projectunity/services/admin/leave_service.dart' as _i2;
...
class MockAdminLeaveService extends _i1.Mock implements _i2.AdminLeaveService {
  ...
  @override
  _i3.Future<List<_i4.Leave>> getMoreRecentLeaves({
    required List<_i4.Leave>? leaves,
    int? limit = 10,
  }) =>
      (super.noSuchMethod(
        Invocation.method(
