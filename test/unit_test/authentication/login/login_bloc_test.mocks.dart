...
// in projectunity/test/unit_test/authentication/login_bloc_test.dart.
...
import 'package:projectunity/navigation/navigation_stack_manager.dart' as _i9;
import 'package:projectunity/provider/user_data.dart' as _i8;
import 'package:projectunity/services/auth/auth_service.dart' as _i5;
import 'package:projectunity/stateManager/auth/auth_manager.dart' as _i7;
...
class MockAuthManager extends _i1.Mock implements _i7.AuthManager {
  ...
  @override
  _i6.Future<void> updateUser(_i2.Employee? user) => (super.noSuchMethod(
        Invocation.method(
          #updateUser,
          [user],
        ),
  ...
  @override
  _i6.Future<_i2.Employee?> getUser(String? email) => (super.noSuchMethod(
        Invocation.method(
          #getUser,
          [email],
        ),
...
class MockNavigationStackManager extends _i1.Mock
    implements _i9.NavigationStackManager {
  ...
  @override
  _i3.NavStackItem get previousState => (super.noSuchMethod(
...
class MockUser extends _i1.Mock implements _i4.User {
  ...
  @override
  _i6.Future<_i4.UserCredential> linkWithPopup(_i11.AuthProvider? provider) =>
      (super.noSuchMethod(
        Invocation.method(
          #linkWithPopup,
          [provider],
