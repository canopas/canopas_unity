...
class MockUserPreference extends _i1.Mock implements _i11.UserPreference {
  ...
  @override
  _i5.Future<void> setAccount(_i8.Account? user) => (super.noSuchMethod(
        Invocation.method(
          #setAccount,
          [user],
        ),
  ...
  @override
  _i5.Future<void> removeAccount() => (super.noSuchMethod(
        Invocation.method(
          #removeAccount,
          [],
        ),
  ...
  @override
  _i5.Future<void> removeEmployee() => (super.noSuchMethod(
        Invocation.method(
          #removeEmployee,
          [],
        ),
