...
class MockLeaveService extends _i1.Mock implements _i6.LeaveService {
  ...
  @override
  _i4.Stream<List<_i7.Leave>> leaveDBSnapshot() => (super.noSuchMethod(
        Invocation.method(
          #leaveDBSnapshot,
          [],
        ),
  ...
  @override
  _i4.Stream<List<_i7.Leave>> leaveDBSnapshotOfUser(String? uid) =>
      (super.noSuchMethod(
        Invocation.method(
  ...
  @override
  _i4.Future<List<_i7.Leave>> getAllApprovedLeaves() => (super.noSuchMethod(
        Invocation.method(
  ...
  @override
  _i4.Stream<List<_i7.Leave>> getRequestedLeaveSnapshot(String? id) =>
      (super.noSuchMethod(
        Invocation.method(
  ...
  @override
  _i4.Future<_i7.Leave?> fetchLeave(String? leaveId) => (super.noSuchMethod(
        Invocation.method(
          #fetchLeave,
          [leaveId],
        ),
