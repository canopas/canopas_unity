...
@GenerateMocks([EmployeeService,AdminLeaveService,NavigationStackManager])
void main(){
  ...
  setUpAll((){
       ...
       whoIsOutViewBloc = WhoIsOutViewBloc(employeeService, adminLeaveService, stackManager);
  });
