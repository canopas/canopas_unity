...
class MockUserPreference extends _i1.Mock implements _i10.UserPreference {
  ...
  @override
  _i5.Future<void> setSpace(_i8.Space? space) => (super.noSuchMethod(
        Invocation.method(
          #setSpace,
          [space],
        ),
  ...
  @override
  _i5.Future<void> setSpaceUser(_i3.Employee? user) => (super.noSuchMethod(
        Invocation.method(
          #setSpaceUser,
          [user],
        ),
  ...
  @override
  _i5.Future<void> removeSpaceUser() => (super.noSuchMethod(
        Invocation.method(
          #removeSpaceUser,
          [],
        ),
