...
// in projectunity/test/unit_test/user/home/leave_calendar/bloc/user_leave_calendar_view_bloc/user_leave_calendar_test.dart.
...
import 'package:projectunity/services/admin/employee_service.dart' as _i5;
import 'package:projectunity/services/admin/paid_leave_service.dart' as _i7;
...
class MockUserLeaveService extends _i1.Mock implements _i2.UserLeaveService {
  ...
  @override
  _i3.Future<List<_i4.Leave>> getPastLeavesOfUser({
    required String? id,
    required List<_i4.Leave>? previousLeaves,
  }) =>
      (super.noSuchMethod(
        Invocation.method(
          #getPastLeavesOfUser,
