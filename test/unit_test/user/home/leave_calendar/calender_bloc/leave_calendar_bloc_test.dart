...
import 'package:projectunity/ui/user/home/leave_calendar/bloc/calendar_bloc/leave_calendar_event.dart';
import 'package:projectunity/ui/user/home/leave_calendar/bloc/calendar_bloc/leave_calendar_state.dart';
...
void main() {
  ...
  group(" leave Calendar Test", () {
    test("change calendar format test", () {
      ...
      emitsInOrder([
        const LeaveCalendarState(calendarFormat: CalendarFormat.twoWeeks),
    ...
    test("change date range test", () {
      ...
      leaveCalendarBloc.add(DateRangeSelectedCalendarEvent(
          date, date.add(const Duration(days: 1)), date));
      emits(LeaveCalendarState(
          endDate: date,
          startDate: date,
          selectedDate: date,
