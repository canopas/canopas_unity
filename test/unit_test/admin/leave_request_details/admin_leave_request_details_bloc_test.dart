...
void main() {
  ...
  setUp(() {
    ...
    adminLeaveRequestDetailsBloc = AdminLeaveApplicationDetailsBloc(
        userLeaveService, adminLeaveService, paidLeaveService);
    loadingState = const AdminLeaveApplicationDetailsState(
  ...
  group("Leave Details Screen Test", () {
    test("fetch leave count test", () {
      ...
      adminLeaveRequestDetailsBloc.add(
          AdminLeaveRequestDetailsInitialLoadEvents(
              leaveApplication: leaveApplication));
      expect(
          adminLeaveRequestDetailsBloc.stream,
          emitsInOrder([
            loadingState,
    ...
    test("approve leave application test", () {
      ...
      adminLeaveRequestDetailsBloc.add(
          AdminLeaveApplicationDetailsApproveRequestEvent(leaveId: "leave-id"));
      expect(
          adminLeaveRequestDetailsBloc.stream,
          emitsInOrder([
            const AdminLeaveApplicationDetailsState(
    ...
    test("reject leave application test", () {
      ...
      adminLeaveRequestDetailsBloc.add(
          AdminLeaveApplicationDetailsRejectRequestEvent(leaveId: "leave-id"));
      expect(
          adminLeaveRequestDetailsBloc.stream,
          emitsInOrder([
            const AdminLeaveApplicationDetailsState(
