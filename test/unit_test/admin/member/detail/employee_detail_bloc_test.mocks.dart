...
import 'package:projectunity/data/repo/employee_repo.dart' as _i18;
...
class MockUserStateNotifier extends _i1.Mock implements _i14.UserStateNotifier {
  ...
  @override
  _i9.Future<void> setSpace({required _i15.Space? space}) =>
      (super.noSuchMethod(
        Invocation.method(
          #setSpace,
          [],
  ...
  @override
  _i9.Future<void> updateSpace(_i15.Space? space) => (super.noSuchMethod(
        Invocation.method(
          #updateSpace,
          [space],
        ),
...
///
/// See the documentation for Mockito's code generation for more information.
class MockSpaceService extends _i1.Mock implements _i17.SpaceService {
  MockSpaceService() {
    _i1.throwOnMissingStub(this);
  }
  ...
  @override
  _i9.Future<_i15.Space?> getSpace(String? spaceId) => (super.noSuchMethod(
        Invocation.method(
          #getSpace,
          [spaceId],
        ),
        returnValue: _i9.Future<_i15.Space?>.value(),
      ) as _i9.Future<_i15.Space?>);
  @override
  _i9.Future<void> createSpace({required _i15.Space? space}) =>
      (super.noSuchMethod(
        Invocation.method(
          #createSpace,
          [],
...
///
/// See the documentation for Mockito's code generation for more information.
class MockEmployeeRepo extends _i1.Mock implements _i18.EmployeeRepo {
  MockEmployeeRepo() {
    _i1.throwOnMissingStub(this);
  }
