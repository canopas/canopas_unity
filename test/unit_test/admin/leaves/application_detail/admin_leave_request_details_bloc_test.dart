  ...
  group('Leave Application Detail bloc', () {
    group('test for Leave Count state', () {
      ...
      test(
        ...
        () {
          ...
          expectLater(
            bloc.stream,
            emitsInOrder([leaveCountLoadingState, successState]),
          );
      ...
      test(
        ...
        () {
          when(
            leaveRepo.getUserUsedLeaves(uid: 'id'),
          ...
          expectLater(
            bloc.stream,
            emitsInOrder([leaveCountLoadingState, errorState]),
          );
          bloc.add(AdminLeaveDetailsFetchLeaveCountEvent(employeeId: 'id'));
        },
      );
    ...
    group('Response to leave Application', () {
      ...
      test(
        ...
        () {
          when(
            notificationService.leaveResponse(
              name: "dummy",
      ...
      test(
        ...
        () {
          ...
          expectLater(
            bloc.stream,
            emitsInOrder([responseLoadingState, errorState]),
          );
        },
      );
    });
