...
// in projectunity/test/unit_test/admin/leaves/detail/admin_leave_detail_bloc_test.dart.
...
class MockLeaveService extends _i1.Mock implements _i5.LeaveService {
  ...
  @override
  _i6.Future<List<_i7.Leave>> getPastLeavesOfUser(String? id) =>
      (super.noSuchMethod(
        Invocation.method(
          #getPastLeavesOfUser,
          [id],
...
class MockUserManager extends _i1.Mock implements _i8.UserManager {
  ...
  @override
  _i6.Future<void> setUser(_i9.User? user) => (super.noSuchMethod(
        Invocation.method(
          #setUser,
          [user],
        ),
