...
@GenerateMocks([SpaceService, UserManager, EmployeeService, StorageService, ImagePicker,XFile])
void main() {
  ...
  setUp(() {
    ...
    bloc = CreateSpaceBLoc(spaceService, userManager, employeeService,imagePicker,storageService);
