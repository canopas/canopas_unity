...
import 'package:projectunity/data/model/employee/employee.dart' as _i12;
...
class MockUserStateNotifier extends _i1.Mock implements _i11.UserStateNotifier {
  ...
  _i8.Future<void> setEmployeeWithSpace({
    ...
    required _i12.Employee? spaceUser,
    bool? redirect = true,
  }) =>
      (super.noSuchMethod(
        Invocation.method(
  ...
  @override
  _i8.Future<void> resetStreamSubscription() => (super.noSuchMethod(
        Invocation.method(
  ...
  @override
  _i8.Future<void> updateCurrentUser(_i12.Employee? user) =>
      (super.noSuchMethod(
        Invocation.method(
          #updateCurrentUser,
          [user],
...
class MockEmployeeService extends _i1.Mock implements _i15.EmployeeService {
  ...
  @override
  _i8.Stream<List<_i12.Employee>> employees(String? spaceId) =>
      (super.noSuchMethod(
        Invocation.method(
          #employees,
          [spaceId],
        ),
        returnValue: _i8.Stream<List<_i12.Employee>>.empty(),
      ) as _i8.Stream<List<_i12.Employee>>);
  @override
  _i8.Future<void> addEmployeeBySpaceId({
    required _i12.Employee? employee,
    required String? spaceId,
  }) =>
      (super.noSuchMethod(
        Invocation.method(
  ...
  @override
  _i8.Future<_i12.Employee?> getEmployeeBySpaceId({
    ...
    required String? spaceId,
      ...
      (super.noSuchMethod(
        ...
        returnValue: _i8.Future<_i12.Employee?>.value(),
      ) as _i8.Future<_i12.Employee?>);
  @override
  _i8.Future<List<_i12.Employee>> getEmployees() => (super.noSuchMethod(
        Invocation.method(
          #getEmployees,
          [],
        ),
        returnValue: _i8.Future<List<_i12.Employee>>.value(<_i12.Employee>[]),
      ) as _i8.Future<List<_i12.Employee>>);

  @override
  _i8.Future<_i12.Employee?> getEmployee(String? id) => (super.noSuchMethod(
        Invocation.method(
          #getEmployee,
          [id],
        ),
  ...
  @override
  _i8.Stream<_i12.Employee?> getCurrentUser({
    required String? spaceId,
    required String? id,
  }) =>
      (super.noSuchMethod(
        ...
        returnValue: _i8.Stream<_i12.Employee?>.empty(),
      ) as _i8.Stream<_i12.Employee?>);
  ...
  @override
  _i8.Future<void> addEmployee(_i12.Employee? employee) => (super.noSuchMethod(
        Invocation.method(
          #addEmployee,
          [employee],
        ),
  ...
  @override
  _i8.Future<void> updateEmployeeDetails({required _i12.Employee? employee}) =>
      (super.noSuchMethod(
        Invocation.method(
  ...
  _i8.Future<void> changeAccountStatus({
    required String? id,
    required _i12.EmployeeStatus? status,
  }) =>
      (super.noSuchMethod(
        Invocation.method(
          #changeAccountStatus,
