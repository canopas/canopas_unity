...
import 'package:projectunity/pref/user_preference.dart' as _i2;
...
class MockUserPreference extends _i1.Mock implements _i2.UserPreference {
  MockUserPreference() {
  ...
  @override
  _i3.Future<bool> removeCurrentUser() => (super.noSuchMethod(
        Invocation.method(
          #removeCurrentUser,
          [],
        ),
