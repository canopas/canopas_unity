...
// in projectunity/test/unit_test/employee/leave_request_view/leave_request_form_view_test.dart.
...
import 'package:projectunity/services/admin/paid_leave/paid_leave_service.dart'
    as _i4;
import 'package:projectunity/services/leave/user_leave_service.dart' as _i6;
...
class MockPaidLeaveService extends _i1.Mock implements _i4.PaidLeaveService {
...
class MockUserLeaveService extends _i1.Mock implements _i6.UserLeaveService {
  ...
  @override
  _i5.Future<List<_i7.Leave>> getUpcomingLeaves(String? employeeId) =>
      (super.noSuchMethod(
        Invocation.method(
          #getUpcomingLeaves,
          [employeeId],
