...
// in projectunity/test/unit_test/employee/all_leaves_view/all_leaves_view_bloc/all_leaves_view_bloc_test.dart.
...
import 'package:projectunity/services/admin/paid_leave_service.dart' as _i3;
...
class MockUserLeaveService extends _i1.Mock implements _i5.UserLeaveService {
  ...
  @override
  _i4.Future<List<_i6.Leave>> getPastLeaves(String? employeeId) =>
      (super.noSuchMethod(
        Invocation.method(
          #getPastLeaves,
          [employeeId],
